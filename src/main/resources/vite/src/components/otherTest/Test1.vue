...
body{background:#b1b1b1;margin:0px;padding:0px;font-size:18px;color:#000;}
...
.menuHolder li.s1 > a {font-size:18px;position:absolute; display:block; width:100px; height:100px; background:#707070; border-radius:0 0 100px 0;}
...
.menuHolder ul li:hover > a {background:#00a0e9; color:#fff;}
.menuHolder li.s2:hover > a {background:#00a0e9; color:#fff;}
.menuHolder .a6 li:hover > a {background:#00a0e9; color:#fff;}
.menuHolder .a5 li:hover > a {background:#00a0e9; color:#fff;}
.menuHolder .a3 li:hover > a {background:#00a0e9; color:#fff;}
