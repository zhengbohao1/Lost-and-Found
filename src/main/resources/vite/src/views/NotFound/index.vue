<template>  
  <canvas width="800" height="400" id="canvas"><p class="nope">页面不存在</p></canvas>
<header>
  <div id="about">
      <h1 style="font-size: 30px; margin-left: -10%; margin-top: 10%;">找不到该页面</h1> 
      <el-link :underline="false" @click="back()"><h1>返回主页</h1></el-link>
