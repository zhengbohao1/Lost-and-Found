...
import { deletePost, queryPost, deletePosts } from '@/apis/found';
import { ElNotification } from 'element-plus';
import { ElCheckbox, ElCheckboxGroup, ElMessage } from 'element-plus'; // 引入必要的组件
